...
def many_learner_feature_importance_heatmap(item_relevance: np.array, x_ids_sorted: list, idx_sorted: list,
                                            n_diagnoses: int, number_of_questions: int=20):
...
def run():
    ...
    parser.add_argument("-e", "--extension", type=str, default='pdf', choices=['png', 'pdf', 'html'])
    ...
    fig = many_learner_feature_importance_stacked(learners_sorted_by_aggregate, x_ids_sorted_by_aggregate,
